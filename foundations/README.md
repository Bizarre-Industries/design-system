...
This milestone governs primitives, semantic color roles for five modes, typography roles, geometry, motion, contrast declarations, and deterministic publication. It does not complete a component library, platform overlays, Helling product design, Arabic typography, downstream theme migration, or cross-platform certification.
